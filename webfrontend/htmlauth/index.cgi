...
# Variables
my $plugintitle = "PhilipsAir";
my $helplink = "https://wiki.loxberry.de/plugins/philipsair/start";
...
sub form {
  if ($load eq "2") {
    ...
    $template->param('loglist_html', LoxBerry::Web::loglist_html( PACKAGE => 'philipsair' ))
  } else {
